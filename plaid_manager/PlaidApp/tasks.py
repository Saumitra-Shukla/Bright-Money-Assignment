...
import datetime
import plaid
from PlaidApp.models import AccountModel, BankItemModel, TransactionModel, APILogModel
...
def get_transactions(access_token=None, bank_item_id=None, new_transactions=500,days=30):
	if access_token is None:
		access_token = BankItemModel.objects.get(item_id=item_id).access_token
